...
long_dataset_clean$looking_time <- long_dataset_clean$looking_time %>% replace_na("NC")
long_dataset_clean$total_trial_time <- long_dataset_clean$total_trial_time %>% replace_na("NC")
